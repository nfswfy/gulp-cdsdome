(function (angular) {
    function ApplyForJoinService($resource, $q, $http, UrlConfigService) {
        var _schema = [
    ...
    ApplyForJoinService.prototype = Object.create(BaseListService.prototype);
    ApplyForJoinService.$inject = ['$resource', '$q', '$http', 'UrlConfigService'];
    angular.module('MetronicApp').service('ApplyForJoinService', ApplyForJoinService);
})(angular);
