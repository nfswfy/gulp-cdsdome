(function (angular) {
    function MyJoinTeamService($resource, $q, $http, UrlConfigService) {
        var _schema = [
    ...
    MyJoinTeamService.prototype = Object.create(BaseListService.prototype);
    MyJoinTeamService.$inject = ['$resource', '$q', '$http', 'UrlConfigService'];
    angular.module('MetronicApp').service('MyJoinTeamService', MyJoinTeamService);
})(angular);
