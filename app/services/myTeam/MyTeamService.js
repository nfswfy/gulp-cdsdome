(function (angular) {
    function MyTeamService($resource, $q, $http, UrlConfigService) {
        var _schema = [
    ...
    MyTeamService.prototype = Object.create(BaseListService.prototype);
    MyTeamService.$inject = ['$resource', '$q', '$http', 'UrlConfigService'];
    angular.module('MetronicApp').service('MyTeamService', MyTeamService);
})(angular);
