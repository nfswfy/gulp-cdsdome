(function (angular) {
    function ViewMyApplyService($resource, $q, $http, UrlConfigService) {
        var _schema = [
    ...
    ViewMyApplyService.prototype = Object.create(BaseListService.prototype);
    ViewMyApplyService.$inject = ['$resource', '$q', '$http', 'UrlConfigService'];
    angular.module('MetronicApp').service('ViewMyApplyService', ViewMyApplyService);
})(angular);
